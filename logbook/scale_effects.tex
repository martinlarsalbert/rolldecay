...
\emph{"According to Himeno \cite{himeno_prediction_1981} scale effects
...
critical damping of the rolling motion."} \cite{soder_assessment_2019}.

\subsection{Damping was higher in full scale \cite{soder_assessment_2019}}
Roll decay model test and full scale tests were conducted in \cite{soder_assessment_2019}.
\begin{itemize}
...
applying roll damping evaluated from model tests on full scale vessels."} \cite{soder_assessment_2019}.